...
class ThemeRepo {
	constructor () {
		...
		this.css = `
			...
			.themerepo-modal .themeEntry.zack .bda-header {
				height: 28px;
			}
			.themerepo-modal .themeEntry.zack .bda-footer {
				height: 42px;
			}
			...
			.themerepo-modal .themeEntry.zack .previewCheckboxWrapper {
				top: 4px;
			}
			...
			.themerepo-modal .themeEntry.jiiks .favIcon,
			.themerepo-modal .themeEntry.jiiks .gitIcon {
				top: 12px;
			}
			.themerepo-modal .themeEntry.zack .favIcon,
			.themerepo-modal .themeEntry.zack .gitIcon {
				top: 6px;
			}
			.themerepo-modal .themeEntry .trashIcon {
				right: 120px;
			}
			.themerepo-modal .themeEntry.jiiks .trashIcon {
				bottom: 25px;
			}
			.themerepo-modal .themeEntry.zack .trashIcon {
				bottom: 14px;
			}
			...
			.themerepo-modal .themeEntry.jiiks .btn-download {
				bottom: 10px;
			}
			.themerepo-modal .themeEntry.zack .btn-download {
				bottom: 4px;
			}
