...
class PluginRepo {
	constructor () {
		...
		this.css = `
			...
			.pluginrepo-modal .pluginEntry.zack .bda-header {
				height: 28px;
			}
			.pluginrepo-modal .pluginEntry.zack .bda-footer {
				height: 42px;
			}
			...
			.pluginrepo-modal .pluginEntry.jiiks .favIcon,
			.pluginrepo-modal .pluginEntry.jiiks .gitIcon {
				top: 12px;
			}
			.pluginrepo-modal .pluginEntry.zack .favIcon,
			.pluginrepo-modal .pluginEntry.zack .gitIcon {
				top: 6px;
			}
			.pluginrepo-modal .pluginEntry .trashIcon {
				right: 120px;
			}
			.pluginrepo-modal .pluginEntry.jiiks .trashIcon {
				bottom: 25px;
			}
			...
			.pluginrepo-modal .pluginEntry.jiiks .btn-download {
				bottom: 10px;
			}
			.pluginrepo-modal .pluginEntry.zack .btn-download {
				bottom: 4px;
			}
