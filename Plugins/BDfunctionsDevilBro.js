...
BDfunctionsDevilBro.languages = {
	...
	"af":		{name:"Afrikaans",					id:"af",		ownlang:"Afrikaans",				integrated:false},
	"sq":		{name:"Albanian",					id:"sq",		ownlang:"Shqiptar",					integrated:false},
	"am":		{name:"Amharic",					id:"am",		ownlang:"አማርኛ",					integrated:false},
	"ar":		{name:"Arabic",						id:"ar",		ownlang:"اللغة العربية",			integrated:false},
	"hy":		{name:"Armenian",					id:"hy",		ownlang:"Հայերեն",					integrated:false},
	"az":		{name:"Azerbaijani",				id:"az",		ownlang:"آذربایجان دیلی",			integrated:false},
	"eu":		{name:"Basque",						id:"eu",		ownlang:"Euskara",					integrated:false},
	"be":		{name:"Belarusian",					id:"be",		ownlang:"Беларуская",				integrated:false},
	"bn":		{name:"Bengali",					id:"bn",		ownlang:"বাংলা",						integrated:false},
	"bs":		{name:"Bosnian",					id:"bs",		ownlang:"Босански",					integrated:false},
	"bg":		{name:"Bulgarian",					id:"bg",		ownlang:"български",				integrated:true},
	"my":		{name:"Burmese",					id:"my",		ownlang:"မြန်မာစာ",					integrated:false},
	"ca":		{name:"Catalan",					id:"ca",		ownlang:"Català",					integrated:false},
	"ceb":		{name:"Cebuano",					id:"ceb",		ownlang:"Bisaya",					integrated:false},
	"ny":		{name:"Chewa",						id:"ny",		ownlang:"Nyanja",					integrated:false},
	"zh-HK":	{name:"Chinese (Hong Kong)",		id:"zh-HK",		ownlang:"香港中文",					integrated:false},
	"zh-CN":	{name:"Chinese (Simplified)",		id:"zh-CN",		ownlang:"简体中文",					integrated:false},
	"zh-TW":	{name:"Chinese (Traditional)",		id:"zh-TW",		ownlang:"繁體中文",					integrated:true},
	"co":		{name:"Corsican",					id:"co",		ownlang:"Corsu",					integrated:false},
	...
	"eo":		{name:"Esperanto",					id:"eo",		ownlang:"Esperanto",				integrated:false},
	"et":		{name:"Estonian",					id:"et",		ownlang:"Eesti",					integrated:false},
	"fil":		{name:"Filipino",					id:"fil",		ownlang:"Wikang Filipino",			integrated:false},
	"fi":		{name:"Finnish",					id:"fi",		ownlang:"Suomi",					integrated:true},
	"fr":		{name:"French",						id:"fr",		ownlang:"Français",					integrated:true},
	"fr-CA":	{name:"French (Canadian)",			id:"fr-CA",		ownlang:"Français Canadien",		integrated:false},
	"fy":		{name:"Frisian",					id:"fy",		ownlang:"Frysk",					integrated:false},
	"gl":		{name:"Galician",					id:"gl",		ownlang:"Galego",					integrated:false},
	"ka":		{name:"Georgian",					id:"ka",		ownlang:"ქართული",				integrated:false},
	"de":		{name:"German",						id:"de",		ownlang:"Deutsch",					integrated:true},
	"de-AT":	{name:"German (Austria)",			id:"de-AT",		ownlang:"Österreichisch Deutsch",	integrated:false},
	"de-CH":	{name:"German (Switzerland)",		id:"de-CH",		ownlang:"Schweizerdeutsch",			integrated:false},
	"el":		{name:"Greek",						id:"el",		ownlang:"Ελληνικά",					integrated:false},
	"gu":		{name:"Gujarati",					id:"gu",		ownlang:"ગુજરાતી",					integrated:false},
	"ht":		{name:"Haitian Creole",				id:"ht",		ownlang:"Kreyòl Ayisyen",			integrated:false},
	"ha":		{name:"Hausa",						id:"ha",		ownlang:"حَوْسَ",						integrated:false},
	"haw":		{name:"Hawaiian",					id:"haw",		ownlang:"ʻŌlelo Hawaiʻi",			integrated:false},
	"iw":		{name:"Hebrew",						id:"iw",		ownlang:"עברית",					integrated:false},
	"hi":		{name:"Hindi",						id:"hi",		ownlang:"हिन्दी",						integrated:false},
	"hmn":		{name:"Hmong",						id:"hmn",		ownlang:"lol Hmongb",				integrated:false},
	"hu":		{name:"Hungarain",					id:"hu",		ownlang:"Magyar",					integrated:false},
	"is":		{name:"Icelandic",					id:"is",		ownlang:"Íslenska",					integrated:false},
	"ig":		{name:"Igbo",						id:"ig",		ownlang:"Asụsụ Igbo",				integrated:false},
	"id":		{name:"Indonesian",					id:"id",		ownlang:"Bahasa Indonesia",			integrated:false},
	"ga":		{name:"Irish",						id:"ga",		ownlang:"Gaeilge",					integrated:false},
	"it":		{name:"Italian",					id:"it",		ownlang:"Italiano",					integrated:true},
	"ja":		{name:"Japanese",					id:"ja",		ownlang:"日本語",					integrated:true},
	"jv":		{name:"Javanese",					id:"jv",		ownlang:"ꦧꦱꦗꦮ",					integrated:false},
	"kn":		{name:"Kannada",					id:"kn",		ownlang:"ಕನ್ನಡ",						integrated:false},
	"kk":		{name:"Kazakh",						id:"kk",		ownlang:"Қазақ Tілі",				integrated:false},
	"km":		{name:"Khmer",						id:"km",		ownlang:"ភាសាខ្មែរ",					integrated:false},
	"ko":		{name:"Korean",						id:"ko",		ownlang:"한국어",					integrated:true},
	"ku":		{name:"Kurdish",					id:"ku",		ownlang:"کوردی",					integrated:false},
	"ky":		{name:"Kyrgyz",						id:"ky",		ownlang:"кыргызча",					integrated:false},
	"lo":		{name:"Lao",						id:"lo",		ownlang:"ພາສາລາວ",					integrated:false},
	"la":		{name:"Latin",						id:"la",		ownlang:"Latina",					integrated:false},
	"lv":		{name:"Latvian",					id:"lv",		ownlang:"Latviešu",					integrated:false},
	"lt":		{name:"Lithuanian",					id:"lt",		ownlang:"Lietuvių",					integrated:false},
	"lb":		{name:"Luxembourgish",				id:"lb",		ownlang:"Lëtzebuergesch",			integrated:false},
	"mk":		{name:"Macedonian",					id:"mk",		ownlang:"Mакедонски",				integrated:false},
	"mg":		{name:"Malagasy",					id:"mg",		ownlang:"Malagasy",					integrated:false},
	"ms":		{name:"Malay",						id:"ms",		ownlang:"بهاس ملايو",				integrated:false},
	"ml":		{name:"Malayalam",					id:"ml",		ownlang:"മലയാളം",					integrated:false},
	"mt":		{name:"Maltese",					id:"mt",		ownlang:"Malti",					integrated:false},
	"mi":		{name:"Maori",						id:"mi",		ownlang:"te Reo Māori",				integrated:false},
	"mr":		{name:"Marathi",					id:"mr",		ownlang:"मराठी",						integrated:false},
	"mn":		{name:"Mongolian",					id:"mn",		ownlang:"Монгол Хэл",				integrated:false},
	"ne":		{name:"Nepali",						id:"ne",		ownlang:"नेपाली",						integrated:false},
	"no":		{name:"Norwegian",					id:"no",		ownlang:"Norsk",					integrated:true},
	"ps":		{name:"Pashto",						id:"ps",		ownlang:"پښتو",						integrated:false},
	"fa":		{name:"Persian",					id:"fa",		ownlang:"فارسی",					integrated:false},
	"pl":		{name:"Polish",						id:"pl",		ownlang:"Polski",					integrated:true},
	"pt":		{name:"Portuguese",					id:"pt",		ownlang:"Português",				integrated:false},
	"pt-BR":	{name:"Portuguese (Brazil)",		id:"pt-BR",		ownlang:"Português do Brasil",		integrated:true},
	"pt-PT":	{name:"Portuguese (Portugal)",		id:"pt-PT",		ownlang:"Português do Portugal",	integrated:false},
	"pa":		{name:"Punjabi",					id:"pa",		ownlang:"पंजाबी",						integrated:false},
	"ro":		{name:"Romanian",					id:"ro",		ownlang:"Română",					integrated:false},
	"ru":		{name:"Russian",					id:"ru",		ownlang:"Pусский",					integrated:true},
	"sm":		{name:"Samoan",						id:"sm",		ownlang:"Gagana Sāmoa",				integrated:false},
	"gd":		{name:"Scottish Gaelic",			id:"gd",		ownlang:"Gàidhlig",					integrated:false},
	"sr":		{name:"Serbian",					id:"sr",		ownlang:"Српски",					integrated:false},
	"st":		{name:"Sotho",						id:"st",		ownlang:"Sesotho",					integrated:false},
	"sn":		{name:"Shona",						id:"sn",		ownlang:"Shona",					integrated:false},
	"sd":		{name:"Sindhi",						id:"sd",		ownlang:"سنڌي",						integrated:false},
	"si":		{name:"Sinhala",					id:"si",		ownlang:"සිංහල",					integrated:false},
	"sk":		{name:"Slovak",						id:"sk",		ownlang:"Slovenčina",				integrated:false},
	"sl":		{name:"Slovenian",					id:"sl",		ownlang:"Slovenščina",				integrated:false},
	"es":		{name:"Spanish",					id:"es",		ownlang:"Español",					integrated:true},
	"es-419":	{name:"Spanish (Latin America)",	id:"es-419",	ownlang:"Español latinoamericano",	integrated:false},
	"sw":		{name:"Swahili",					id:"sw",		ownlang:"Kiswahili",				integrated:false},
	"sv":		{name:"Swedish",					id:"sv",		ownlang:"Svenska",					integrated:true},
	"tg":		{name:"Tajik",						id:"tg",		ownlang:"тоҷикӣ",					integrated:false},
	"ta":		{name:"Tamil",						id:"ta",		ownlang:"தமிழ்",						integrated:false},
	"te":		{name:"Telugu",						id:"te",		ownlang:"తెలుగు",					integrated:false},
	"th":		{name:"Thai",						id:"th",		ownlang:"ภาษาไทย",					integrated:false},
	"tr":		{name:"Turkish",					id:"tr",		ownlang:"Türkçe",					integrated:true},
	"uk":		{name:"Ukrainian",					id:"uk",		ownlang:"Yкраїнський",				integrated:true},
	"ur":		{name:"Urdu",						id:"ur",		ownlang:"اُردُو",						integrated:false},
	"uz":		{name:"Uzbek",						id:"uz",		ownlang:"اوزبیک",					integrated:false},
	"vi":		{name:"Vietnamese",					id:"vi",		ownlang:"Tiếng Việt Nam",			integrated:false},
	"cy":		{name:"Welsh",						id:"cy",		ownlang:"Cymraeg",					integrated:false},
	"xh":		{name:"Xhosa",						id:"xh",		ownlang:"Xhosa",					integrated:false},
	"yi":		{name:"Yiddish",					id:"yi",		ownlang:"ייִדיש ייִדיש‬",				integrated:false},
	"yo":		{name:"Yoruba",						id:"yo",		ownlang:"Èdè Yorùbá",				integrated:false},
	"zu":		{name:"Zulu",						id:"zu",		ownlang:"Zulu",						integrated:false}
};
