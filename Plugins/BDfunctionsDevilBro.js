...
BDfunctionsDevilBro.languages = {
	...
	Arabic:			{name:"Arabic",						id:"ar",		integrated:false},
	Afrikaans:		{name:"Afrikaans",					id:"af",		integrated:false},
	Amharic:		{name:"Amharic",					id:"am",		integrated:false},
	Armenian:		{name:"Armenian",					id:"hy",		integrated:false},
	Azerbaijani:	{name:"Azerbaijani",				id:"az",		integrated:false},
	Basque:			{name:"Basque",						id:"eu",		integrated:false},
	Bengali:		{name:"Bengali",					id:"bn",		integrated:false},
	Bulgarian:		{name:"Bulgarian",					id:"bg",		integrated:true},
	Catalan:		{name:"Catalan",					id:"ca",		integrated:false},
	ChineseHK:		{name:"Chinese (Hong Kong)",		id:"zh-HK",		integrated:false},
	ChineseS:		{name:"Chinese (Simplified)",		id:"zh-CN",		integrated:false},
	ChineseT:		{name:"Chinese (Traditional)",		id:"zh-TW",		integrated:true},
	Croatian:		{name:"Croatian",					id:"hr",		integrated:true},
	Czech:			{name:"Czech",						id:"cs",		integrated:true},
	Danish:			{name:"Danish",						id:"da",		integrated:true},
	Dutch:			{name:"Dutch",						id:"nl",		integrated:true},
	EnglishUK:		{name:"English (UK)",				id:"en-GB",		integrated:true},
	EnglishUS:		{name:"English (US)",				id:"en",		integrated:true},
	Estonian:		{name:"Estonian",					id:"et",		integrated:false},
	Filipino:		{name:"Filipino",					id:"fil",		integrated:false},
	Finnish:		{name:"Finnish",					id:"fi",		integrated:true},
	French:			{name:"French",						id:"fr",		integrated:true},
	FrenchC:		{name:"French (Canadian)",			id:"fr-CA",		integrated:false},
	Galician:		{name:"Galician",					id:"gl",		integrated:false},
	Georgian:		{name:"Georgian",					id:"ka",		integrated:false},
	German:			{name:"German",						id:"de",		integrated:true},
	GermanA:		{name:"German (Austria)",			id:"de-AT",		integrated:false},
	GermanS:		{name:"German (Switzerland)",		id:"de-CH",		integrated:false},
	Greek:			{name:"Greek",						id:"el",		integrated:false},
	Gujarati:		{name:"Gujarati",					id:"gu",		integrated:false},
	Hebrew:			{name:"Hebrew",						id:"iw",		integrated:false},
	Hindi:			{name:"Hindi",						id:"hi",		integrated:false},
	Hungarain:		{name:"Hungarain",					id:"hu",		integrated:false},
	Icelandic:		{name:"Icelandic",					id:"is",		integrated:false},
	Indonesian:		{name:"Indonesian",					id:"id",		integrated:false},
	Italian:		{name:"Italian",					id:"it",		integrated:true},
	Japanese:		{name:"Japanese",					id:"ja",		integrated:true},
	Kannada:		{name:"Kannada",					id:"kn",		integrated:false},
	Korean:			{name:"Korean",						id:"ko",		integrated:true},
	Laothian:		{name:"Laothian",					id:"lo",		integrated:false},
	Latvian:		{name:"Latvian",					id:"lv",		integrated:false},
	Lithuanian:		{name:"Lithuanian",					id:"lt",		integrated:false},
	Malay:			{name:"Malay",						id:"ms",		integrated:false},
	Malayalam:		{name:"Malayalam",					id:"ml",		integrated:false},
	Marathi:		{name:"Marathi",					id:"mr",		integrated:false},
	Mongolian:		{name:"Mongolian",					id:"mn",		integrated:false},
	Norwegian:		{name:"Norwegian",					id:"no",		integrated:true},
	Persian:		{name:"Persian",					id:"fa",		integrated:false},
	Polish:			{name:"Polish",						id:"pl",		integrated:true},
	Portuguese:		{name:"Portuguese",					id:"pt",		integrated:false},
	PortugueseB:	{name:"Portuguese (Brazil)",		id:"pt-BR",		integrated:true},
	PortugueseP:	{name:"Portuguese (Portugal)",		id:"pt-PT",		integrated:false},
	Romanian:		{name:"Romanian",					id:"ro",		integrated:false},
	Russian:		{name:"Russian",					id:"ru",		integrated:true},
	Serbian:		{name:"Serbian",					id:"sr",		integrated:false},
	Sinhalese:		{name:"Sinhalese",					id:"si",		integrated:false},
	Slovak:			{name:"Slovak",						id:"sk",		integrated:false},
	Slovenian:		{name:"Slovenian",					id:"sl",		integrated:false},
	Spanish:		{name:"Spanish",					id:"es",		integrated:true},
	SpanishL:		{name:"Spanish (Latin America)",	id:"es-419",	integrated:false},
	Swahili:		{name:"Swahili",					id:"sw",		integrated:false},
	Swedish:		{name:"Swedish",					id:"sv",		integrated:true},
	Tamil:			{name:"Tamil",						id:"ta",		integrated:false},
	Telugu:			{name:"Telugu",						id:"te",		integrated:false},
	Thai:			{name:"Thai",						id:"th",		integrated:false},
	Turkish:		{name:"Turkish",					id:"tr",		integrated:true},
	Ukrainian:		{name:"Ukrainian",					id:"uk",		integrated:true},
	Urdu:			{name:"Urdu",						id:"ur",		integrated:false},
	Vietnamese:		{name:"Vietnamese",					id:"vi",		integrated:false},
	Zulu:			{name:"Zulu",						id:"zu",		integrated:false}
};
...
BDfunctionsDevilBro.zacksFork = function () {
	return (typeof bbdVersion !== "undefined" && typeof bdpluginErrors === "object" && typeof bdthemeErrors === "object");
};
