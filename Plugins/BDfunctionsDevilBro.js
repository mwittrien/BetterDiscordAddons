...
BDfunctionsDevilBro.languages = {
	...
	"ar":		{name:"Arabic",						id:"ar",		google:true,		integrated:false},
	"hy":		{name:"Armenian",					id:"hy",		google:true,		integrated:false},
	"az":		{name:"Azerbaijani",				id:"az",		google:true,		integrated:false},
	"eu":		{name:"Basque",						id:"eu",		google:true,		integrated:false},
	"bn":		{name:"Bengali",					id:"bn",		google:true,		integrated:false},
	"be":		{name:"Belarusian",					id:"be",		google:true,		integrated:false},
	"bn":		{name:"Bengali",					id:"bn",		google:true,		integrated:false},
	"bs":		{name:"Bosnian",					id:"bs",		google:true,		integrated:false},
	"bg":		{name:"Bulgarian",					id:"bg",		ownlang:"български",				google:true,		integrated:true},
	"my":		{name:"Burmese",					id:"my",		google:true,		integrated:false},
	"ca":		{name:"Catalan",					id:"ca",		google:true,		integrated:false},
	"ceb":		{name:"Cebuano",					id:"ceb",		google:true,		integrated:false},
	"ny":		{name:"Chichewa",					id:"ny",		google:true,		integrated:false},
	"zh-HK":	{name:"Chinese (Hong Kong)",		id:"zh-HK",		google:true,		integrated:false},
	"zh-CN":	{name:"Chinese (Simplified)",		id:"zh-CN",		google:true,		integrated:false},
	"zh-TW":	{name:"Chinese (Traditional)",		id:"zh-TW",		ownlang:"繁體中文",					google:true,		integrated:true},
	"co":		{name:"Corsician",					id:"co",		google:true,		integrated:false},
	"hr":		{name:"Croatian",					id:"hr",		ownlang:"Hrvatski",					google:true,		integrated:true},
	"cs":		{name:"Czech",						id:"cs",		ownlang:"Čeština",					google:true,		integrated:true},
	"da":		{name:"Danish",						id:"da",		ownlang:"Dansk",					google:true,		integrated:true},
	"nl":		{name:"Dutch",						id:"nl",		ownlang:"Nederlands",				google:true,		integrated:true},
	...
	"fr":		{name:"French",						id:"fr",		ownlang:"Français",					google:true,		integrated:true},
	"fr-CA":	{name:"French (Canadian)",			id:"fr-CA",		google:false,		integrated:false},
	"fy":		{name:"Frisian",					id:"fy",		google:true,		integrated:false},
	"gl":		{name:"Galician",					id:"gl",		google:true,		integrated:false},
	"ka":		{name:"Georgian",					id:"ka",		google:true,		integrated:false},
	"de":		{name:"German",						id:"de",		ownlang:"Deutsch",					google:true,		integrated:true},
	"de-AT":	{name:"German (Austria)",			id:"de-AT",		google:false,		integrated:false},
	"de-CH":	{name:"German (Switzerland)",		id:"de-CH",		google:false,		integrated:false},
	"el":		{name:"Greek",						id:"el",		google:true,		integrated:false},
	"gu":		{name:"Gujarati",					id:"gu",		google:true,		integrated:false},
	"ht":		{name:"Haitian Creole",				id:"ht",		google:true,		integrated:false},
	"ha":		{name:"Hausa",						id:"ha",		google:true,		integrated:false},
	"haw":		{name:"Hawaiian",					id:"haw",		google:true,		integrated:false},
	"iw":		{name:"Hebrew",						id:"iw",		google:true,		integrated:false},
	"hi":		{name:"Hindi",						id:"hi",		google:true,		integrated:false},
	"hmn":		{name:"Hmong",						id:"hmn",		google:true,		integrated:false},
	"hu":		{name:"Hungarain",					id:"hu",		google:true,		integrated:false},
	"is":		{name:"Icelandic",					id:"is",		google:true,		integrated:false},
	"ig":		{name:"Igbo",						id:"ig",		google:true,		integrated:false},
	"id":		{name:"Indonesian",					id:"id",		google:true,		integrated:false},
	"ga":		{name:"Irish",						id:"ga",		google:true,		integrated:false},
	"it":		{name:"Italian",					id:"it",		ownlang:"Italiano",					google:true,		integrated:true},
	"ja":		{name:"Japanese",					id:"ja",		ownlang:"日本語",					google:true,		integrated:true},
	"jv":		{name:"Javanese",					id:"jv",		google:true,		integrated:false},
	"kn":		{name:"Kannada",					id:"kn",		google:true,		integrated:false},
	"kk":		{name:"Kazakh",						id:"kk",		google:true,		integrated:false},
	"km":		{name:"Khmer",						id:"km",		google:true,		integrated:false},
	"ko":		{name:"Korean",						id:"ko",		ownlang:"한국어",					google:true,		integrated:true},
	"ku":		{name:"Kurdish",					id:"ku",		google:true,		integrated:false},
	"ky":		{name:"Kyrgyz",						id:"ky",		google:true,		integrated:false},
	"lo":		{name:"Laothian",					id:"lo",		google:true,		integrated:false},
	"la":		{name:"Latin",						id:"la",		google:true,		integrated:false},
	"lv":		{name:"Latvian",					id:"lv",		google:true,		integrated:false},
	"lt":		{name:"Lithuanian",					id:"lt",		google:true,		integrated:false},
	"lb":		{name:"Luxembourgish",				id:"lb",		google:true,		integrated:false},
	"mk":		{name:"Macedonian",					id:"mk",		google:true,		integrated:false},
	"mg":		{name:"Malagasy",					id:"mg",		google:true,		integrated:false},
	"ms":		{name:"Malay",						id:"ms",		google:true,		integrated:false},
	"ml":		{name:"Malayalam",					id:"ml",		google:true,		integrated:false},
	"mt":		{name:"Maltese",					id:"mt",		google:true,		integrated:false},
	"mi":		{name:"Maori",						id:"mi",		google:true,		integrated:false},
	"mr":		{name:"Marathi",					id:"mr",		google:true,		integrated:false},
	"mn":		{name:"Mongolian",					id:"mn",		google:true,		integrated:false},
	"ne":		{name:"Nepali",						id:"ne",		google:true,		integrated:false},
	"no":		{name:"Norwegian",					id:"no",		ownlang:"Norsk",					google:true,		integrated:true},
	"ps":		{name:"Pashto",						id:"ps",		google:true,		integrated:false},
	"fa":		{name:"Persian",					id:"fa",		google:true,		integrated:false},
	"pl":		{name:"Polish",						id:"pl",		ownlang:"Polski",					google:true,		integrated:true},
	"pt":		{name:"Portuguese",					id:"pt",		google:true,		integrated:false},
	"pt-BR":	{name:"Portuguese (Brazil)",		id:"pt-BR",		ownlang:"Português do Brasil",		google:false,		integrated:true},
	"pt-PT":	{name:"Portuguese (Portugal)",		id:"pt-PT",		google:false,		integrated:false},
	"pa":		{name:"Punjabi",					id:"pa",		google:true,		integrated:false},
	"ro":		{name:"Romanian",					id:"ro",		google:true,		integrated:false},
	"ru":		{name:"Russian",					id:"ru",		ownlang:"Pусский",					google:true,		integrated:true},
	"sm":		{name:"Samoan",						id:"sm",		google:true,		integrated:false},
	"gd":		{name:"Scots Gaelic",				id:"gd",		google:true,		integrated:false},
	"sr":		{name:"Serbian",					id:"sr",		google:true,		integrated:false},
	"st":		{name:"Sesotho",					id:"st",		google:true,		integrated:false},
	"sn":		{name:"Shona",						id:"sn",		google:true,		integrated:false},
	"sd":		{name:"Sindhi",						id:"sd",		google:true,		integrated:false},
	"si":		{name:"Sinhala",					id:"si",		google:true,		integrated:false},
	"sk":		{name:"Slovak",						id:"sk",		google:true,		integrated:false},
	"sl":		{name:"Slovenian",					id:"sl",		google:true,		integrated:false},
	"es":		{name:"Spanish",					id:"es",		ownlang:"Español",					google:true,		integrated:true},
	"es-419":	{name:"Spanish (Latin America)",	id:"es-419",	google:false,		integrated:false},
	"sw":		{name:"Swahili",					id:"sw",		google:true,		integrated:false},
	"sv":		{name:"Swedish",					id:"sv",		ownlang:"Svenska",					google:true,		integrated:true},
	"tg":		{name:"Tajik",						id:"tg",		google:true,		integrated:false},
	"ta":		{name:"Tamil",						id:"ta",		google:true,		integrated:false},
	"te":		{name:"Telugu",						id:"te",		google:true,		integrated:false},
	"th":		{name:"Thai",						id:"th",		google:true,		integrated:false},
	"tr":		{name:"Turkish",					id:"tr",		ownlang:"Türkçe",					google:true,		integrated:true},
	"uk":		{name:"Ukrainian",					id:"uk",		ownlang:"Yкраїнський",				google:true,		integrated:true},
	"ur":		{name:"Urdu",						id:"ur",		google:true,		integrated:false},
	"uz":		{name:"Uzbek",						id:"uz",		google:true,		integrated:false},
	"vi":		{name:"Vietnamese",					id:"vi",		google:true,		integrated:false},
	"cy":		{name:"Welsh",						id:"cy",		google:true,		integrated:false},
	"xh":		{name:"Xhosa",						id:"xh",		google:true,		integrated:false},
	"yi":		{name:"Yiddish",					id:"yi",		google:true,		integrated:false},
	"yo":		{name:"Yoruba",						id:"yo",		google:true,		integrated:false},
	"zu":		{name:"Zulu",						id:"zu",		google:true,		integrated:false}
};
