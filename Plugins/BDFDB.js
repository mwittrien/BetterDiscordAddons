...
BDFDB.DiscordClasses = {
	...
	dms: "dms-rcsEnV",
	dmchannel: {stable:"channel", canary:"channel-2QD9_O", ptb:"channel"},
	dmchannelactivity: {stable:"channel-activity", canary:"activity-525YDR", ptb:"channel-activity"},
	dmchannelactivityicon: {stable:"channel-activity-icon", canary:"activityIcon-1mtTk4", ptb:"channel-activity-icon"},
	dmchannelactivityiconforeground: {stable:"channel-activity-icon-foreground", canary:"activityIconForeground-3VIgI8", ptb:"channel-activity-icon-foreground"},
	dmchannelactivitytext: {stable:"channel-activity-text", canary:"activityText-OW8WYb", ptb:"channel-activity-text"},
	dmchannelclose: {stable:"close", canary:"close-3hZ5Ni", ptb:"close"},
	dmchannelname: {stable:"channel-name", canary:"name-2WpE7M", ptb:"channel-name"},
	dmchannelprivate: "private",
	dmchannels: {stable:"private-channels", canary:"privateChannels-1nO12o", ptb:"private-channels"},
