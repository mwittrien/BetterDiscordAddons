		...
		return class ServerFolders extends Plugin {
			...
			setLabelsByLanguage () {
				switch (BDFDB.LanguageUtils.getLanguage().id) {
					...
					case "da":		// Danish
						return {
							foldercontext_autoreadfolder:		"Auto: Marker som l��st",
							foldercontext_mutefolder:			"D��mp mappe",
							foldercontext_removefolder:			"Slet mappe",
							modal_colorpicker1:					"Prim��r mappefarve",
							modal_colorpicker2:					"Sekund��r mappefarve",
							modal_colorpicker3:					"V��rkt��jstipfarve",
							...
							modal_tabheader3:					"V��rkt��jstipfarve",
							...
							serversubmenu_addtofolder:			"F��j serveren til mappen",
					...
					case "de":		// German
						return {
							...
							foldercontext_removefolder:			"Ordner l��schen",
							modal_colorpicker1:					"Prim��re Ordnerfarbe",
							modal_colorpicker2:					"Sekund��re Ordnerfarbe",
							modal_colorpicker3:					"Tooltipfarbe",
							modal_colorpicker4:					"Schriftfarbe",
							modal_copytooltipcolor:				"Dieselbe Farbe f��r alle Server eines Ordners verwenden",
							modal_customclosed:					"Geschlossenes Icon",
							modal_customopen:					"Ge��ffnetes Icon",
							modal_custompreview:				"Symbolvorschau",
							modal_iconpicker:					"Ordnerauswahl",
							modal_swapcolor:					"Die zweite Farbe f��r den urspr��nglichen Ordner verwenden",
							...
							serversubmenu_addtofolder:			"Server zum Ordner hinzuf��gen",
					...
					case "es":		// Spanish
						return {
							foldercontext_autoreadfolder:		"Autom��tico: marcar como le��do",
							...
							modal_colorpicker3:					"Color de la informaci��n sobre herramientas",
							...
							modal_iconpicker:					"Selecci��n de carpeta",
							...
							modal_tabheader3:					"Color de la informaci��n sobre herramientas",
							modal_tabheader4:					"S��mbolos propios",
					...
					case "fi":		// Finnish
						return {
							...
							modal_colorpicker1:					"Ensisijaisen kansion v��ri",
							modal_colorpicker2:					"Toissijaisen kansion v��ri",
							modal_colorpicker3:					"Ty��kaluvinkin v��ri",
							modal_colorpicker4:					"Fontin v��ri",
							modal_copytooltipcolor:				"K��yt�� samaa v��ri�� kaikille kansion palvelimille",
							...
							modal_swapcolor:					"K��yt�� alkuper��isen kansion toista v��ri��",
							modal_tabheader1:					"Kansio",
							modal_tabheader2:					"Kansion v��ri",
							modal_tabheader3:					"Ty��kaluvinkin v��ri",
							modal_tabheader4:					"Omat symbolit",
							modal_usecloseicon:					"K��yt�� suljetun kuvaketta minipalvelimen sijaan",
					...
					case "fr":		// French
						return {
							...
							modal_copytooltipcolor:				"Utilisez la m��me couleur pour tous les serveurs d'un dossier",
							modal_customclosed:					"Ic��ne ferm��e",
							modal_customopen:					"Ic��ne ouverte",
							modal_custompreview:				"Aper��u de l'ic��ne",
							modal_iconpicker:					"S��lection de dossier",
							modal_swapcolor:					"Utilisez la deuxi��me couleur pour le dossier d'origine",
							...
							modal_usecloseicon:					"Utilisez une ic��ne ferm��e au lieu du miniserver",
							servercontext_serverfolders:		"Dossier du serveur",
							serversubmenu_addtofolder:			"Ajouter le serveur au dossier",
							serversubmenu_createfolder:			"Cr��er le dossier",
							serversubmenu_removefromfolder:		"Supprimer le serveur du dossier"
						};
					case "hr":		// Croatian
						return {
							foldercontext_autoreadfolder:		"Automatski: Ozna��i kao pro��itano",
							foldercontext_mutefolder:			"Isklju��i mapu",
							foldercontext_removefolder:			"Izbri��i mapu",
							...
							modal_copytooltipcolor:				"Koristite istu boju za sve poslu��itelje u mapi",
							...
							servercontext_serverfolders:		"Mapa poslu��itelja",
							serversubmenu_addtofolder:			"Dodajte poslu��itelj u mapu",
							serversubmenu_createfolder:			"Stvori mapu",
							serversubmenu_removefromfolder:		"Uklonite poslu��itelj iz mape"
						};
					case "hu":		// Hungarian
						return {
							foldercontext_autoreadfolder:		"Automatikus: Megjel��l��s olvasottk��nt",
							foldercontext_mutefolder:			"Mappa n��m��t��sa",
							foldercontext_removefolder:			"Mappa t��rl��se",
							modal_colorpicker1:					"Els��dleges mappa sz��ne",
							modal_colorpicker2:					"M��sodlagos mappa sz��ne",
							modal_colorpicker3:					"Eszk��zt��r sz��ne",
							modal_colorpicker4:					"Bet�� sz��n",
							modal_copytooltipcolor:				"Haszn��lja ugyanazt a sz��nt egy mappa ��sszes kiszolg��l��j��hoz",
							modal_customclosed:					"Z��rt ikonra",
							modal_customopen:					"Megnyit��s ikonra",
							modal_custompreview:				"Ikon el��n��zet",
							modal_iconpicker:					"Mappa kiv��laszt��sa",
							modal_swapcolor:					"Haszn��lja az eredeti mappa m��sodik sz��n��t",
							modal_tabheader1:					"Mapp��ba",
							modal_tabheader2:					"Mappa sz��ne",
							modal_tabheader3:					"Eszk��zt��r sz��ne",
							modal_tabheader4:					"Saj��t szimb��lumok",
							modal_usecloseicon:					"Haszn��ljon z��rt ikont a miniszerver helyett",
							servercontext_serverfolders:		"Szerver mappa",
							serversubmenu_addtofolder:			"Adja hozz�� a szervert a mapp��hoz",
							serversubmenu_createfolder:			"Mappa l��trehoz��s",
							serversubmenu_removefromfolder:		"T��vol��tsa el a szervert a mapp��b��l"
						};
					case "it":		// Italian
						return {
					...
					case "lt":		// Lithuanian
						return {
							foldercontext_autoreadfolder:		"Automatinis: pa��ym��ti kaip perskaityt��",
							foldercontext_mutefolder:			"Nutildyti aplank��",
							foldercontext_removefolder:			"I��trinti aplank��",
							...
							modal_copytooltipcolor:				"Naudokite t�� pa��i�� spalv�� visiems aplanko serveriams",
							modal_customclosed:					"U��daryta piktograma",
							modal_customopen:					"Atidaryti piktogram��",
							modal_custompreview:				"Piktogramos per��i��ra",
							...
							modal_usecloseicon:					"Vietoj miniserverio naudokite u��dar�� piktogram��",
							servercontext_serverfolders:		"Serverio aplankas",
							serversubmenu_addtofolder:			"Prid��kite server�� prie aplanko",
							serversubmenu_createfolder:			"Sukurti aplank��",
							serversubmenu_removefromfolder:		"Pa��alinti server�� i�� aplanko"
						};
					case "nl":		// Dutch
						return {
					...
					case "no":		// Norwegian
						return {
							...
							modal_colorpicker1:					"Prim��r mappefarge",
							modal_colorpicker2:					"Sekund��r mappefarge",
							modal_colorpicker3:					"Verkt��ytipsfarge",
					...
					case "pl":		// Polish
						return {
							...
							foldercontext_removefolder:			"Usuni��ty folder",
							modal_colorpicker1:					"G����wny kolor folderu",
							modal_colorpicker2:					"Kolor folderu dodatkowego",
							modal_colorpicker3:					"Kolor podpowiedzi",
							modal_colorpicker4:					"Kolor czcionki",
							modal_copytooltipcolor:				"U��yj tego samego koloru dla wszystkich serwer��w w folderze",
							modal_customclosed:					"Ikona zamkni��ta",
							modal_customopen:					"Otw��rz ikon��",
							modal_custompreview:				"Podgl��d ikon",
							modal_iconpicker:					"Wyb��r folderu",
							modal_swapcolor:					"U��yj drugiego koloru dla oryginalnego folderu",
							modal_tabheader1:					"Teczka",
							modal_tabheader2:					"Kolor folderu",
							modal_tabheader3:					"Kolor podpowiedzi",
							modal_tabheader4:					"W��asne symbole",
							modal_usecloseicon:					"U��yj zamkni��tej ikony zamiast miniserwera",
							servercontext_serverfolders:		"Folder serwera",
							serversubmenu_addtofolder:			"Dodaj serwer do folderu",
							serversubmenu_createfolder:			"Utw��rz folder",
					...
					case "pt-BR":	// Portuguese (Brazil)
						return {
							...
							modal_colorpicker1:					"Cor da pasta prim��ria",
							modal_colorpicker2:					"Cor secund��ria da pasta",
							...
							modal_custompreview:				"Antevis��o do ��cone",
							modal_iconpicker:					"Sele����o de pasta",
							...
							modal_tabheader4:					"S��mbolos pr��prios",
					...
					case "ro":		// Romanian
						return {
							foldercontext_autoreadfolder:		"Automat: marca��i ca citit",
							foldercontext_mutefolder:			"Dezactiva��i folderul",
							foldercontext_removefolder:			"��terge��i folderul",
							...
							modal_copytooltipcolor:				"Utiliza��i aceea��i culoare pentru toate serverele dintr-un folder",
							...
							modal_swapcolor:					"Utiliza��i a doua culoare pentru folderul original",
							...
							modal_usecloseicon:					"Folosi��i o pictogram�� ��nchis�� ��n locul miniserverului",
							servercontext_serverfolders:		"Dosar server",
							serversubmenu_addtofolder:			"Ad��uga��i serverul ��n dosar",
							serversubmenu_createfolder:			"Creeaza dosar",
							serversubmenu_removefromfolder:		"Elimina��i serverul din dosar"
						};
					case "ru":		// Russian
						return {
							foldercontext_autoreadfolder:		"��������: ���������������� ������ ����������������������",
					...
					case "sv":		// Swedish
						return {
							foldercontext_autoreadfolder:		"Auto: Markera som l��st",
							foldercontext_mutefolder:			"Tyst mapp",
							foldercontext_removefolder:			"Ta bort mapp",
							modal_colorpicker1:					"Prim��r mappf��rg",
							modal_colorpicker2:					"Sekund��r mappf��rg",
							modal_colorpicker3:					"Verktygstipsf��rg",
							modal_colorpicker4:					"Fontf��rg",
							modal_copytooltipcolor:				"Anv��nd samma f��rg f��r alla servrar i en mapp",
							modal_customclosed:					"St��ngd ikon",
							modal_customopen:					"��ppna ikonen",
							modal_custompreview:				"Ikonf��rhandsvisning",
							modal_iconpicker:					"Mappval",
							modal_swapcolor:					"Anv��nd den andra f��rgen f��r den ursprungliga mappen",
							modal_tabheader1:					"Mapp",
							modal_tabheader2:					"Mappf��rg",
							modal_tabheader3:					"Verktygstipsf��rg",
							modal_tabheader4:					"Egna symboler",
							modal_usecloseicon:					"Anv��nd en st��ngd ikon ist��llet f��r miniserver",
							servercontext_serverfolders:		"Servermapp",
							serversubmenu_addtofolder:			"L��gg till servern i mappen",
							serversubmenu_createfolder:			"Skapa mapp",
							serversubmenu_removefromfolder:		"Ta bort servern fr��n mappen"
						};
					case "th":		// Thai
						return {
							foldercontext_autoreadfolder:		"���������������������������: ������������������������������������������������������������������������",
					...
					case "tr":		// Turkish
						return {
							foldercontext_autoreadfolder:		"Otomatik: Okundu olarak i��aretle",
							foldercontext_mutefolder:			"Klas��r�� sessize al",
							foldercontext_removefolder:			"Klas��r�� sil",
							modal_colorpicker1:					"Birincil klas��r rengi",
							modal_colorpicker2:					"��kincil klas��r rengi",
							modal_colorpicker3:					"Ara�� ipucu rengi",
							modal_colorpicker4:					"Yaz�� rengi",
							modal_copytooltipcolor:				"Bir klas��rdeki t��m sunucular i��in ayn�� rengi kullan��n",
							modal_customclosed:					"Kapal�� simge",
							modal_customopen:					"A�� simgesi",
							modal_custompreview:				"Simge ��nizlemesi",
							modal_iconpicker:					"Klas��r se��imi",
							modal_swapcolor:					"Orijinal klas��r i��in ikinci rengi kullan��n",
							modal_tabheader1:					"Klas��r",
							modal_tabheader2:					"Klas��r rengi",
							modal_tabheader3:					"Ara�� ipucu rengi",
							modal_tabheader4:					"Kendi sembolleri",
							modal_usecloseicon:					"Miniserver yerine kapal�� bir simge kullan��n",
							servercontext_serverfolders:		"Sunucu klas��r��",
							serversubmenu_addtofolder:			"Sunucuyu klas��re ekleyin",
							serversubmenu_createfolder:			"Klas��r olu��turun",
							serversubmenu_removefromfolder:		"Sunucuyu klas��rden kald��r"
						};
					case "uk":		// Ukrainian
						return {
							foldercontext_autoreadfolder:		"��������: ������������������ ���� ������������������",
					...
					case "vi":		// Vietnamese
						return {
							foldercontext_autoreadfolder:		"T��� �����ng: ����nh d���u l�� ���� �����c",
							foldercontext_mutefolder:			"Th�� m���c ���n",
							foldercontext_removefolder:			"X��a th�� m���c",
							modal_colorpicker1:					"M��u th�� m���c ch��nh",
							modal_colorpicker2:					"M��u th�� m���c ph���",
							modal_colorpicker3:					"M��u ch�� gi���i c��ng c���",
							modal_colorpicker4:					"M��u ph��ng ch���",
							modal_copytooltipcolor:				"S��� d���ng c��ng m���t m��u cho t���t c��� c��c m��y ch��� trong m���t th�� m���c",
							modal_customclosed:					"Bi���u t�����ng ���� ����ng",
							modal_customopen:					"M��� bi���u t�����ng",
							modal_custompreview:				"Xem tr�����c bi���u t�����ng",
							modal_iconpicker:					"L���a ch���n th�� m���c",
							modal_swapcolor:					"S��� d���ng m��u th��� hai cho th�� m���c g���c",
							modal_tabheader1:					"Th�� m���c",
							modal_tabheader2:					"M��u th�� m���c",
							modal_tabheader3:					"M��u ch�� gi���i c��ng c���",
							modal_tabheader4:					"K�� hi���u ri��ng",
							modal_usecloseicon:					"S��� d���ng bi���u t�����ng ���� ����ng thay v�� tr��nh thu nh���",
							servercontext_serverfolders:		"Th�� m���c m��y ch���",
							serversubmenu_addtofolder:			"Th��m m��y ch��� v��o th�� m���c",
							serversubmenu_createfolder:			"T���o th�� m���c",
							serversubmenu_removefromfolder:		"X��a m��y ch��� kh���i th�� m���c"
						};
