...
class NotificationSounds {
	...
	initConstructor () {
		this.changelog = {
			"fixed":[["Settings","Fixed the bug where you couldn't save the muted settings"]]
		};
