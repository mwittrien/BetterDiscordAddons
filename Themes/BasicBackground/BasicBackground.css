...
.group-1WdBVp {												/* rolesettings			permissions group					*/
	border-color: rgb(var(--vtransparencycolor), 0.4);
}
...
.passthrough-1c2ewQ.selected-2YhbGh {						/* rolesettings			permissions passthrough selected	*/
	background: rgb(var(--vtransparencycolor), 0.4);
	color: rgb(var(--fontwhite1));
}
...
#app-mount .ctaBar-2UsjF2 {									/* current boost stats	container							*/
	background-color: rgba(var(--vtransparencycolor), 0.4);
	background-image: url(https://discord.com/assets/94ff6fdc535b6ecb7b1bc54f2dd56a10.svg);
}
...
#app-mount .checkbox-1ix_J3.checked-3_4uQ9[style*="border-color: rgba(67, 181, 129, 0.15)"] {
	background-color: rgba(var(--vaccentcolor), 0.15) !important;
	border-color: rgba(var(--vaccentcolor), 0.15) !important;
}
...
#app-mount #dv-main {
	border-top-color: rgba(var(--vtransparencycolor), 0.2);
	color: rgb(var(--fontwhite1));
}
