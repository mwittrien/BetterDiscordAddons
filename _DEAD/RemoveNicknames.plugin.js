				...
				BDFDB.ModalUtils.open(this, {
					...
					buttons: [
						{contents: "DELETE", close: true, color: "RED", onClick: _ => {
							BDFDB.LibraryRequires.fs.unlink(BDFDB.LibraryRequires.path.join(BDFDB.BDUtils.getPluginsFolder(), "RemoveNicknames.plugin.js"), error => {});
							BDFDB.LibraryRequires.fs.unlink(BDFDB.LibraryRequires.path.join(BDFDB.BDUtils.getPluginsFolder(), "RemoveNicknames.config.json"), error => {});
						}}
					]
				});
			}
