...
module.exports = (_ => {
	...
	return !window.BDFDB_Global || (!window.BDFDB_Global.loaded && !window.BDFDB_Global.started) ? class {
		...
		downloadLibrary () {
			BdApi.Net.fetch("https://mwittrien.github.io/BetterDiscordAddons/Library/0BDFDB.plugin.js", (e, r, b) => {
		...
		return class RemoveBlockedUsers extends Plugin {
			...
			onStart () {
				BDFDB.ModalUtils.open(this, {
					...
					children: [
						BDFDB.ReactUtils.createElement("span", {children: "I WILL NO LONGER MAINTAIN THIS PLUGIN DUE TO EVER CHANGING UPDATES "}),
					...
					buttons: [
						{contents: "DELETE", close: true, color: "RED", onClick: _ => {
							BDFDB.LibraryRequires.fs.unlink(BDFDB.LibraryRequires.path.join(BDFDB.BDUtils.getPluginsFolder(), "RemoveBlockedUsers.plugin.js"), error => {});
							BDFDB.LibraryRequires.fs.unlink(BDFDB.LibraryRequires.path.join(BDFDB.BDUtils.getPluginsFolder(), "RemoveBlockedUsers.config.json"), error => {});
						}}
					]
				});
			}
