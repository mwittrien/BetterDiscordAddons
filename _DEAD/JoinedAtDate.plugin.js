				...
				BDFDB.ModalUtils.open(this, {
					...
					buttons: [
						{contents: "DELETE", close: true, color: "RED", onClick: _ => {
							BDFDB.LibraryRequires.fs.unlink(BDFDB.LibraryRequires.path.join(BDFDB.BDUtils.getPluginsFolder(), "JoinedAtDate.plugin.js"), error => {});
							BDFDB.LibraryRequires.fs.unlink(BDFDB.LibraryRequires.path.join(BDFDB.BDUtils.getPluginsFolder(), "JoinedAtDate.config.json"), error => {});
						}}
					]
				});
			}
