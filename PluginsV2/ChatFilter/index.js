	...
	return class extends Plugin {
		...
		getSettingsPanel () {
			...
			for (let rtype in replaces) {
				...
				settingshtml += `<div class="flex-lFgbSz flex-3B1Tl4 horizontal-2BEEBe horizontal-2VE-Fw directionRow-yNbSvJ justifyStart-2yIZo0 alignCenter-3VxkQP noWrap-v6g9vO marginBottom8-1mABJ4" style="flex: 0 0 auto;"><h3 class="titleDefault-1CWM9y title-3i-5G_ marginReset-3hwONl weightMedium-13x9Y8 size16-3IvaX_ height24-2pMcnc flexChild-1KGW5q" style="flex: 0 0 auto; width: ${528 - (this.configtypes.length * 33)}px;">List of ${rtype} Words:</h3><div class="flex-3B1Tl4 horizontal-2BEEBe horizontal-2VE-Fw flex-3B1Tl4 directionRow-yNbSvJ justifyCenter-29N31w alignCenter-3VxkQP noWrap-v6g9vO" style="flex: 1 1 auto; max-width: ${this.configtypes.length * 34}px;">`;
				for (let config of this.configtypes) {
				...
				settingshtml += `</div></div><div class="DevilBro-settings-inner ${rtype}-list user-settings-games marginBottom8-1mABJ4">`;				
				for (let word in words) {
