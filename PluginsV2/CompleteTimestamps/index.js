	...
	return class extends Plugin {
		...
		initialize() {
			if (typeof BDfunctionsDevilBro === "object") {
				...
				$(document).on("mouseenter." + this.name, ".message .message-text, .message .accessory", (e) => {
		...
		getSettingsPanel () {
			...
			settingshtml += `<div class="DevilBro-settings-inner info-container" ${infoHidden ? "style='display:none;'" : ""}>`;
