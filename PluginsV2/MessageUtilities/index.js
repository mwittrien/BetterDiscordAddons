	...
	return class extends Plugin {
		...
		initialize() {
			if (typeof BDfunctionsDevilBro === "object") {
				...
				$(document)
					.on("click." + this.name, ".message", (e) => {
						this.onClick(e.currentTarget, 0, "onSglClick");
					})
					.on("dblclick." + this.name, ".message", (e) => {
						this.onClick(e.currentTarget, 1, "onDblClick");
					})
					.on("keydown." + this.name, ".channelTextArea-os01xC", (e) => {
		...
		onStop() {
			if (typeof BDfunctionsDevilBro === "object") {
				$(document).off("click." + this.name, ".message");
				$(document).off("dblclick." + this.name, ".message");
				$(document).off("keydown." + this.name, ".channelTextArea-os01xC");
