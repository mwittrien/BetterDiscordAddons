			...
			if (channelObj) {
				...
				if (!BDfunctionsDevilBro.isObjectEmpty(pins)) {
					...
					for (let messageData of messageArray) {
						...
						$(message).on("click." + this.name, ".close-button", (e) => {
							message.remove();
